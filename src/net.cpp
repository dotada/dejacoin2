...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dejacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"89.215.12.15", "89.215.12.15"},
    {"45.77.153.55", "45.77.153.55"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x54FC1EC8, 0x2D4D9937, 0x0F0CD759
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dejacoin is probably already running."), addrBind.ToString().c_str());
        else
